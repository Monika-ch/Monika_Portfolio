            ...
            <main>
              <section id="story" className='story-section'>
                ...
                <div className='story-container'>
                  <p>I'm a web developer with a passion for turning creative ideas into seamless web experiences. My journey began four years ago in a bootcamp, which led to impactful work with Bing@Work Microsoft. There, I enhanced Bing's enterprise search features, improved accessibility testing frameworks, and developed image search functionalities.</p>

                  <p>In my freelance ventures, I created and launched projects from scratch, like Martian Madness—a responsive web app that attracted over 700 users within a month through NFT minting.</p>

                  <p>Now, I'm immersed in the world of AI. As a Prompt Engineer at Remotasks, I work with large language models like GPT. I focus on prompting, evaluating, and debugging code generation to enhance their precision and relevance.</p>
